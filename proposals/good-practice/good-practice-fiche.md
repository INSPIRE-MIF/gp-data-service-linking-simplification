...
The current approach for linking INSPIRE data sets and its related network services on the base of the requirements established in the relevant Implementing Rules and Technical Guidelines foresees:
  ...
  - the documentation of such network services - mainly highlighting here view and download services - through appropriate metadata where a link to the target spatial data set(s) of the service, namely coupled resource, shall be given;
